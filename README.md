...
visualizing musical intervals, and hear to the frequency ratio.
...
For the sound, we use 220 Hz (A3) as base frequency (`a = 1`). 
For example, a **perfect fifth** (3:2 ratio) plays A4 (440 Hz) and E5 (~660 Hz).
